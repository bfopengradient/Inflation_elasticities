...
class els:
    ...
    #Difference_data function takes the raw data as input to be differenced.
    ...
    #Lag data if needed
    #Shift_data takes as input the raw data to be shifted or lagged and also number of periods by which the raw data is lagged(integer).
